...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PrefixNumbers.prefix'
        db.alter_column('cdr_prefixnumbers', 'prefix', self.gf('django.db.models.fields.CharField')(max_length=6))

    def backwards(self, orm):

        # Changing field 'PrefixNumbers.prefix'
        db.alter_column('cdr_prefixnumbers', 'prefix', self.gf('django.db.models.fields.BigIntegerField')())
